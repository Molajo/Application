 ...
 */
namespace Molajo\Factories\Resourcewrap;
 ...
 * @since      1.0
 */
class ResourcewrapFactoryMethod extends FactoryMethodBase implements FactoryInterface, FactoryBatchInterface
{
    /**
     * Constructor
     *
    ...
    {
        $options['product_namespace']        = 'Molajo\\Resource\\Adapter\\Wrap';
    ...
    protected function setHandlerOptions()
    {
        ...
        $handler_options['scheme_name'] = 'wrap';
