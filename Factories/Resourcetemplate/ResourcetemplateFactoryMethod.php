<?php
/**
 * Resource Template Factory Method
 *
 * @package    Molajo
 * @license    http://www.opensource.org/licenses/mit-license.html MIT License
 * @copyright  2014-2015 Amy Stephen. All rights reserved.
 */
namespace Molajo\Factories\Resourcetemplate;
 ...
 * @since      1.0
 */
class ResourcetemplateFactoryMethod extends FactoryMethodBase implements FactoryInterface, FactoryBatchInterface
{
    /**
     * Constructor
     *
    ...
    {
        $options['product_namespace']        = 'Molajo\\Resource\\Adapter\\Template';
    ...
    protected function setHandlerOptions()
    {
        ...
        $handler_options['scheme_name'] = 'template';
