<?php
/**
 * Resource Page Factory Method
 *
 * @package    Molajo
 * @license    http://www.opensource.org/licenses/mit-license.html MIT License
 * @copyright  2014-2015 Amy Stephen. All rights reserved.
 */
namespace Molajo\Factories\Resourcepage;
 ...
 * @since      1.0
 */
class ResourcepageFactoryMethod extends FactoryMethodBase implements FactoryInterface, FactoryBatchInterface
{
    /**
     * Constructor
     *
    ...
    {
        $options['product_namespace']        = 'Molajo\\Resource\\Adapter\\Page';
    ...
    protected function setHandlerOptions()
    {
        ...
        $handler_options['scheme_name'] = 'page';
