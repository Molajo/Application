...
class ExtensionMap implements ExtensionsInterface
{
    ...
    public function getCatalogTypes()
    {
        ...
        try {
            $catalog_type_controller->select('*');
            $catalog_type_controller->from('#__catalog_types', 'a');
            $catalog_type_controller->where(
                'column',
                $catalog_type_controller->getModelRegistry('prefix', 'a') . '.id',
                'IN',
                'integer',
            ...
            $catalog_type_controller->where(
                'column',
                $catalog_type_controller->getModelRegistry('prefix', 'a') . '.model_type',
                '=',
                'string',
                'Resource',
                'OR'
