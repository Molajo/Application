...
class ApplicationPlugin extends SystemEventPlugin implements SystemInterface
{
    ...
    public function onBeforeExecute()
    {
        ...
        if ($page_type == 'item' || $page_type == 'edit') {
            ...
            $current_menuitem_id = $this->runtime_data->resource->parameters->list_parent_menu_id;
        } else {
            $current_menuitem_id = $this->runtime_data->resource->menuitem->data->id;
        }
    ...
    protected function setPageMeta()
    {
        ...
        if (isset($this->runtime_data->resource->menuitem->data->metadata)) {
            $data = $this->runtime_data->resource->menuitem->data->metadata;
        ...
        if (isset($this->runtime_data->resource->data->metadata)) {
            $data = $this->runtime_data->resource->data->metadata;
